...
class Scoreboard:
    """Una clase para dar informacion a la puntuacion."""
    ...
    def __init__(self, ai_game):
        ...
        # Prepara la imagen de la puntucaion iniciales.
        self.prep_score()
    ...
    def prep_high_score(self):
        ...
        # Centra la puntuacion mas alta en laparte superior de la pantalla.
